...
ap.add_argument("-f", "--folder", required=False, default="pos", help = "foldername")
ap.add_argument("-ws", "--width", required=False, default=50,
	help="width size")
ap.add_argument("-hs", "--height", required=False, default=50,
	help="height size")
